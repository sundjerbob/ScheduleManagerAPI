...
public class ScheduleImporter {
     ...
     * @throws ScheduleException If an I/O error occurs during file reading or if there is an issue parsing date and time information.
     */
    public static List<ScheduleSlot> importScheduleCSV(String csvPath, Map<String, RoomProperties> rooms) throws ScheduleIOException {
        ...
        try {
            ...
            throw new ScheduleIOException("An loading error has occurred in ScheduleImporter:importScheduleCSV().\nError message: " + e.getMessage());
        }
    }
     ...
     * @throws ScheduleIOException If an I/O error occurs during file reading or.
     */
    public static Map<String, RoomProperties> importRoomsCSV(String csvPath) throws ScheduleIOException {
        ...
        try {
            ...
            throw new ScheduleIOException("An loading error has occurred in ScheduleImporter:importRoomsCSV().\nError message: " + e.getMessage());
        }
    }
}
